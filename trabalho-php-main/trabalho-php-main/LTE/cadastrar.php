  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../../LTE/dist/img/matue.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
                ...
                <form role="form" action='cadastrar.php' method='POST'>
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="telefone" class="form-control" id="exampleInputPassword1" placeholder="Telefone">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="rg" class="form-control" id="exampleInputPassword1" placeholder="Rg">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">cpf</label>
                        <input type="cpf" class="form-control" id="exampleInputPassword1" placeholder="Cpf">
                      </div>
                  </div>
                  <!-- /.card-body -->
